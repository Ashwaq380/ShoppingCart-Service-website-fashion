...
$db = new DbOperation(); 
$rows = $db->getOrders($_SESSION['customerID']);
?>
            ...
            <table class="table">
              <thead>
                ...
                <th scope="col" class="border-0 bg-light">
                    <div class="py-2 text-uppercase">orderID</div>
                  </th>
                  <th scope="col" class="border-0 bg-light">
              ...
              <tbody>
                ...
                <tr>
                    <td class="border-0 align-middle"><?php echo $row['OrderID']; ?></td>
                  <th scope="row" class="border-0">
                    <div class="p-2">
                      <img src="<?php echo $row['image'];?>" alt="" width="314" class="img-fluid rounded shadow-sm">
                      <div class="ml-3 d-inline-block align-middle">
                        <h5 class="mb-0"> <a href="#" class="text-dark d-inline-block align-middle"><?php echo $row['productName'];?></a></h5><span class="text-muted font-weight-normal font-italic d-block">Category: <?php echo $row['category']; ?></span>
                      </div>
                    </div>
                  </th>
                  <td class="border-0 align-middle"><strong>SAR <?php echo $row['total']; ?></strong></td>
                </tr>
                <?php }?>
